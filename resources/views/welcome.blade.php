...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        ...
        <br>
            ...
            <u>
                <li>Unidades inadimplentes não terão clientes notificados nem respondidos pelo recurso.</li>
                <li>O número usado para notificação irá recusar imediatamente as tentativas de ligação.</li>
                <li>As notificações poderão representar uma empresa específica, mas o recurso de notificação é do sistema Plus e pode corresponder aos demais clientes.</li>
            </u>
            <br><br>
            <h2>Propriedade</h2>

            O recurso funciona com acesso à base de dados do <a href="" targe="_blank">Plus Intelligence</a> e quaisquer alteração de rotas ou consultas deve ser alinhado com o mesmo.
